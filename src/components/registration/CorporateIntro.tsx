import { CORPORATE_INTRO } from "@/lib/corporate-registration";

// 확정 문단 1개만 사용하는 짧은 editorial 섹션입니다(BankruptcyPropertyNote/
// RealEstateIntro와 동일한 "제목 + 얇은 구분선 + 문단" 패턴). 문단이
// 1개뿐이라 2단 divide-x/divide-y 기법(정확히 2개 항목용)은 적용하지
// 않습니다. 카드 없이 whitespace와 얇은 구분선만으로 앞 Hero와의 리듬을
// 만듭니다.
