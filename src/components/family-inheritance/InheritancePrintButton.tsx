...
// 추가하지 않고 브라우저 기본 인쇄 기능만 사용합니다. 이 버튼을 포함하는
// InheritanceDocumentChecklist는 그대로 서버 컴포넌트로 남겨두기 위해,
// "use client"가 필요한 부분만 이 파일 하나로 분리했습니다. 버튼 자체는
// 인쇄 결과물에 포함될 필요가 없으므로 print:hidden을 둡니다.
export default function InheritancePrintButton() {
  return (
    <button
      type="button"
