...
import { DEBTOR_DEFAULT_LIST_REGISTRATION_META } from "./legal-info-debtor-default-list-registration";
...
import { SUCCESSION_EXECUTION_CLAUSE_OBJECTION_META } from "./legal-info-succession-execution-clause-objection";
